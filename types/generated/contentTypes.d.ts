...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Menu categories (e.g., Appetizers, Main Course, Desserts)';
  ...
  attributes: {
    ...
    products: Schema.Attribute.Relation<'oneToMany', 'api::dish.dish'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiDishDish extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Individual dishes/items on the menu (products)';
    displayName: 'Dish';
    pluralName: 'dishes';
    singularName: 'dish';
  };
  ...
  attributes: {
    ...
    nutritionalInfo: Schema.Attribute.Component<
      'shared.nutritional-info',
      false
    >;
    preparationTime: Schema.Attribute.Integer;
    price: Schema.Attribute.Decimal & Schema.Attribute.Required;
    productMedia: Schema.Attribute.Relation<
      'oneToMany',
    ...
    restaurant: Schema.Attribute.Relation<
      ...
      'api::restaurant.restaurant'
    >;
    spicyLevel: Schema.Attribute.Enumeration<
...
export interface ApiLayoutLayout extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Predefined layout templates for menu display';
    displayName: 'Layout';
    pluralName: 'layouts';
    singularName: 'layout';
  };
  ...
  attributes: {
    ...
    restaurants: Schema.Attribute.Relation<
      ...
      'api::restaurant.restaurant'
    >;
    type: Schema.Attribute.Enumeration<['grid', 'list', 'cards', 'masonry']> &
      Schema.Attribute.Required &
...
export interface ApiMenuMenu extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Restaurant menus (e.g., Lunch, Dinner, Drinks)';
    displayName: 'Menu';
    pluralName: 'menus';
    singularName: 'menu';
  };
...
export interface ApiProductMediaProductMedia
  ...
  info: {
    description: 'Media files (images/videos) for products';
  ...
  attributes: {
    ...
    product: Schema.Attribute.Relation<'manyToOne', 'api::dish.dish'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiRestaurantRestaurant extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    userRestaurants: Schema.Attribute.Relation<
      'oneToMany',
      'api::user-restaurant.user-restaurant'
    >;
  };
}
...
export interface ApiThemeTheme extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Visual themes for restaurant menus';
    displayName: 'Theme';
    pluralName: 'themes';
    singularName: 'theme';
  };
  ...
  attributes: {
    ...
    cardStyle: Schema.Attribute.JSON;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text &
    ...
    headerStyle: Schema.Attribute.JSON;
    isDefault: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    primaryColor: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'#e63946'>;
    publishedAt: Schema.Attribute.DateTime;
    restaurants: Schema.Attribute.Relation<
      'oneToMany',
      'api::restaurant.restaurant'
    ...
    secondaryColor: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'#457b9d'>;
    textColor: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'#1d3557'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiUserRestaurantUserRestaurant
  extends Struct.CollectionTypeSchema {
  collectionName: 'user_restaurants';
  info: {
    description: 'Junction table for many-to-many relationship between users and restaurants';
    displayName: 'User Restaurant';
    pluralName: 'user-restaurants';
    singularName: 'user-restaurant';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    restaurant: Schema.Attribute.Relation<
      ...
      'api::restaurant.restaurant'
    >;
    role: Schema.Attribute.Enumeration<['owner', 'admin', 'staff']> &
      Schema.Attribute.Required &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::user-restaurant.user-restaurant': ApiUserRestaurantUserRestaurant;
